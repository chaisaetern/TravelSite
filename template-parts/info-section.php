...
<section class="info-section" id="aboutSection">
    <div class="infoBox">
        <img src="http://travelsite2.local/wp-content/uploads/2022/05/infobox-img-scaled.jpg" alt="beach chairs with umberellas on a beach." height="490px" width="50%" style="border: 1px solid #000;">
    </div>
